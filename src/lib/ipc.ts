...
export type Command =
  ...
  | "keyboard_fill_keys"
  | "keyboard_oled_test"
  | "keyboard_select_profile"
  | "keyboard_send_raw"
  | "keyboard_set_actuation"
  | "keyboard_set_enabled"
  | "keyboard_set_idle"
  | "keyboard_set_key_actuation"
  | "keyboard_set_key_color"
  | "keyboard_set_lighting"
  | "keyboard_set_oled"
  | "keyboard_set_oled_wire"
  | "keyboard_set_physical"
  | "keyboard_set_power_saving"
  | "keyboard_set_protection_mode"
  | "keyboard_set_rapid_tap"
  | "keyboard_set_rapid_trigger"
  | "keyboard_set_screensaver"
  | "list_buses"
  | "list_eq_presets"
  | "list_profiles"
  | "load_profile"
